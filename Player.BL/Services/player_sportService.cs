...
{
    public class player_SportService : BaseService
    {
        #region player_agendaServices
        public static player_agendaResponse Listplayer_agenda(player_SportRequest request)
        {
        ...
        public static bool RefreshQuoteAndSlots(player_agendaRequest request)
        {
            var model = new slotRecord()
            {
                id = request.player_agendaRecord.slotID ?? 0,
